...
incorrect_config_message = (
    "Config seems incorrect, please check again your env variables"
)
...
OCD_DTL_MISP_HOST = (
    OCD_DTL_MISP_HOST if "://" in OCD_DTL_MISP_HOST else "https://" + OCD_DTL_MISP_HOST
)
OCD_DTL_MISP_API_KEY = os.getenv("OCD_DTL_MISP_API_KEY")
assert OCD_DTL_MISP_API_KEY, incorrect_config_message

OCD_DTL_MISP_USE_SSL = os.getenv("OCD_DTL_MISP_USE_SSL", "True").lower() in [
    "true",
    "1",
]
